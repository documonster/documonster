...
function renderNote(xml: XmlSink, elementName: string, note: FootnoteDef | EndnoteDef): void {
...
export function renderFootnotes(xml: XmlSink, footnotes: readonly FootnoteDef[]): void {
...
export function renderEndnotes(xml: XmlSink, endnotes: readonly EndnoteDef[]): void {
  xml.openXml(STD_DOC_ATTRIBUTES);
