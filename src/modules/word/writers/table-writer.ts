...
/** Render a table cell. */
function renderTableCell(xml: XmlSink, cell: TableCell): void {
  xml.openNode("w:tc");
...
/** Render a table row. */
function renderTableRow(xml: XmlSink, row: TableRow): void {
  xml.openNode("w:tr");
...
export function renderTable(xml: XmlSink, table: Table): void {
  xml.openNode("w:tbl");
