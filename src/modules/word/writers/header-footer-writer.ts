...
import { NS_W, NS_R, NS_V, NS_O, NS_W10, STD_DOC_ATTRIBUTES } from "../constants";
...
function renderContent(xml: XmlSink, content: HeaderFooterContent): void {
...
export function renderHeader(xml: XmlSink, content: HeaderFooterContent): void {
...
export function renderFooter(xml: XmlSink, content: HeaderFooterContent): void {
  xml.openXml(STD_DOC_ATTRIBUTES);
  xml.openNode("w:ftr", {
    "xmlns:w": NS_W,
    "xmlns:r": NS_R
