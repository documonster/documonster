...
const pdf4 = excelToPdf(wb4, { showGridLines: true });
...
const pdf8 = excelToPdf(wb8, { showGridLines: true });
...
const pdf10 = excelToPdf(wb10, { showPageNumbers: true });
