...
const pdf4 = exportPdf(wb4, { showGridLines: true });
...
const pdf8 = exportPdf(wb8, { showGridLines: true });
...
const pdf10 = exportPdf(wb10, { showPageNumbers: true });
