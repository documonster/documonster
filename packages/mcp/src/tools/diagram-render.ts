...
interface DiagramRenderDependencies {
  readonly render: typeof renderDiagram;
}

/** Construct the tool with an observable rendering boundary for focused tests. */
export function createDiagramRenderTool(
  dependencies: DiagramRenderDependencies = { render: renderDiagram }
) {
  return defineTool({
    name: "diagram_render",
    group: "diagram",
...
export const diagramRenderTool = createDiagramRenderTool();
